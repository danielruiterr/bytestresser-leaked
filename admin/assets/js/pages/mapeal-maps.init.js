$(function() {
    ...
    }), $mapusa.on("mousewheel", function(t) {
        return 0 < t.deltaY ? ($mapusa.trigger("zoom", $mapusa.data("zoomLevel") + 1), console.log("zoom")) : $mapusa.trigger("zoom", $mapusa.data("zoomLevel") - 1), !1
    }), $(".mapcontainer").mapael({
        map: {
