...
<html lang="en">
    <head>
        ...
        <!-- App css -->
        <link href="<?php echo $assets; ?>assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo $assets; ?>assets/css/app.css" rel="stylesheet" type="text/css" />
    ...
    <body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form id="Login">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" id="username-login" name="Username" type="text" required="" placeholder="Enter your Username">
                                    </div>

                                    <div class="form-group mb-3">
                                        <label>Password</label>
                                        <input class="form-control" id="password-login" name="Password" type="password" required="" placeholder="Enter your Password">
                                    </div>

                                    <div class="form-group mb-0 text-center">
                                        <span class="btn btn-danger btn-block" onclick="Login()"> Log In </span>
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <!-- <p> <a href="recover" class="text-muted ml-1">Forgot your password?</a></p> -->
                                <p class="text-muted">Don't have an account? <a href="register" class="text-muted ml-1"><b class="font-weight-semibold">Sign Up</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
        ...
        <!-- Notifications -->
        <script src="<?php echo $assets; ?>assets/js/toast.js"></script>
