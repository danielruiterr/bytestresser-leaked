...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>ByteStresser.com - Login</title>
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p>Sign in to continue to Stresser.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" method="POST" id="Login">
                                        ...
                                        <div class="mt-3 d-grid">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <button type="button" class="btn btn-primary waves-effect waves-light w100">Log In</button>
                                                </div>
                                                <div class="col-md-6">
                                                    <a href="<?php echo $assets; ?>register" class="btn btn-primary waves-effect waves-light w100">Register</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
