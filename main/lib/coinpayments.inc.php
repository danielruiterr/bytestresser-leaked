...
class CoinPaymentsAPI {
	private $private_key = '5edd292a7b01fA013DCdA3db055c013741Eefceb0b920abB64421B1007fc330e';
	private $public_key = 'ad527259b7ea6b9677322904eebfcea864c1e8efc657c5601fa93326ba27d2cb';
	private $ch = null;
	 ...
	 */
	public function CreateTransactionSimple($amount, $currency, $buyer_email, $address, $ipn_url) {		
		$req = array(
			'amount' => $amount,
			'currency1' => 'EUR',
			'currency2' => $currency,
